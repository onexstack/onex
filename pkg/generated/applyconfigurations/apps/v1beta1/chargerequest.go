...
func extractChargeRequest(chargeRequest *appsv1beta1.ChargeRequest, fieldManager string, subresource string) (*ChargeRequestApplyConfiguration, error) {
	b := &ChargeRequestApplyConfiguration{}
	err := managedfields.ExtractInto(chargeRequest, internal.Parser().Type("com.github.onexstack.onex.pkg.apis.apps.v1beta1.ChargeRequest"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
