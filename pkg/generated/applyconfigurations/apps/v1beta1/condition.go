...
type ConditionApplyConfiguration struct {
	Type               *appsv1beta1.ConditionType     `json:"type,omitempty"`
	Status             *v1.ConditionStatus            `json:"status,omitempty"`
	Severity           *appsv1beta1.ConditionSeverity `json:"severity,omitempty"`
...
func (b *ConditionApplyConfiguration) WithType(value appsv1beta1.ConditionType) *ConditionApplyConfiguration {
	b.Type = &value
	return b
}
...
func (b *ConditionApplyConfiguration) WithSeverity(value appsv1beta1.ConditionSeverity) *ConditionApplyConfiguration {
	b.Severity = &value
	return b
}
