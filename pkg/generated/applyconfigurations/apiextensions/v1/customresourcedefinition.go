...
// Experimental!
func ExtractCustomResourceDefinition(customResourceDefinition *apisapiextensionsv1.CustomResourceDefinition, fieldManager string) (*CustomResourceDefinitionApplyConfiguration, error) {
	return extractCustomResourceDefinition(customResourceDefinition, fieldManager, "")
}

// ExtractCustomResourceDefinitionStatus is the same as ExtractCustomResourceDefinition except
// that it extracts the status subresource applied configuration.
// Experimental!
func ExtractCustomResourceDefinitionStatus(customResourceDefinition *apisapiextensionsv1.CustomResourceDefinition, fieldManager string) (*CustomResourceDefinitionApplyConfiguration, error) {
	return extractCustomResourceDefinition(customResourceDefinition, fieldManager, "status")
}

func extractCustomResourceDefinition(customResourceDefinition *apisapiextensionsv1.CustomResourceDefinition, fieldManager string, subresource string) (*CustomResourceDefinitionApplyConfiguration, error) {
	b := &CustomResourceDefinitionApplyConfiguration{}
