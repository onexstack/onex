...
func Job(name, namespace string) *JobApplyConfiguration {
	...
	b.WithKind("Job")
	b.WithAPIVersion("batch.onex.io/v1beta1")
	return b
}
...
func extractJob(job *batchv1beta1.Job, fieldManager string, subresource string) (*JobApplyConfiguration, error) {
	b := &JobApplyConfiguration{}
	err := managedfields.ExtractInto(job, internal.Parser().Type("com.github.onexstack.onex.pkg.apis.batch.v1beta1.Job"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(job.Name)
