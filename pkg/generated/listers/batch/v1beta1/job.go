...
type JobLister interface {
	...
	List(selector labels.Selector) (ret []*batchv1beta1.Job, err error)
...
type jobLister struct {
	listers.ResourceIndexer[*batchv1beta1.Job]
}

// NewJobLister returns a new JobLister.
func NewJobLister(indexer cache.Indexer) JobLister {
	return &jobLister{listers.New[*batchv1beta1.Job](indexer, batchv1beta1.Resource("job"))}
}

// Jobs returns an object that can list and get Jobs.
func (s *jobLister) Jobs(namespace string) JobNamespaceLister {
	return jobNamespaceLister{listers.NewNamespaced[*batchv1beta1.Job](s.ResourceIndexer, namespace)}
}
...
type JobNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*batchv1beta1.Job, error)
