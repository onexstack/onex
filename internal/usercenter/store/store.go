...
//go:generate mockgen -self_package github.com/onexstack/onex/internal/usercenter/store -destination mock_store.go -package store github.com/onexstack/onex/internal/usercenter/store IStore,SecretStore,UserStore
