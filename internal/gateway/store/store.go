...
//go:generate mockgen -destination mock_store.go -package store github.com/onexstack/onex/internal/gateway/store IStore,ChainStore,MinerSetStore,MinerStore
