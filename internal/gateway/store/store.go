...
//go:generate mockgen -self_package github.com/onexstack/onex/internal/gateway/store -destination mock_store.go -package store github.com/onexstack/onex/internal/gateway/store IStore,ChainStore,MinerStore,MinerSetStore
