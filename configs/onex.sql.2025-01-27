...
DROP TABLE IF EXISTS `leader_elections`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `leader_elections` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_leader_elections_expires_at` (`expires_at`)
...
CREATE TABLE `ratelimit_leader_election` (
  ...
  `expires_at` datetime(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_ratelimit_leader_election_expires_at` (`expires_at`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1677 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-01-27  8:06:12
